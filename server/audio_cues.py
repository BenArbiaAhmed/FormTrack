...
def play_go_lower_sound():
    try:
        sound = pygame.mixer.Sound('./audio/go-lower.mp3')
        sound.play()
...
def play_bring_arms_colser_sound():
    try:
        sound = pygame.mixer.Sound('./audio/bring-arms-closer.mp3')
        sound.play()
    except Exception:
...
def play_bring_legs_colser_sound():
    try:
        sound = pygame.mixer.Sound('./audio/bring-legs-closer.mp3')
        sound.play()
    except Exception:
        print("An exception happened with audio play.")
...
def play_straighten_your_back_sound():
    try:
        sound = pygame.mixer.Sound('./audio/straighten-your-back.mp3')
        sound.play()
    except Exception:
        print("An exception happened with audio play.")
